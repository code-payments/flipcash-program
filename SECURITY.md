...
<a name="reporting"></a>
## Reporting security problems in the Flipcash Currency Creator Program

Please use this [Report a Vulnerability](https://github.com/code-payments/flipcash-program/security/advisories/new) link.
