use super::uint::U192;
use super::precise_number::{ PreciseNumber, SignedPreciseNumber, InnerUint };
...
pub const fn ln2hi_scale() -> InnerUint {
    U192([7766279631452241920_u64, 5_u64, 0])
}
...
pub const fn ln2lo() -> InnerUint {
    ...
    U192([3405790746697269248_u64, 1034445385942222_u64, 0])
}
...
pub const fn sqrt2overtwo() -> InnerUint {
    U192([707106781186547600_u64, 0, 0])
}
...
pub const fn half() -> InnerUint {
    U192([500000000000000000_u64, 0, 0])
}
